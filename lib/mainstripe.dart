...
class HomeScreen extends StatefulWidget {
  ...
  HomeScreen({Key? key, this.passenger}) : super(key: key);
  @override
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> makePayment() async {
    try {
      String passengerString = '$passenger';
      int totalamount=((50000*int.parse(passengerString)));
  ...
  calculateAmount(String amount) {
    String passengerString = '$passenger';
    final calculatedAmout = (int.parse(amount)) * 100*int.parse(passengerString);
