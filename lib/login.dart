...
var signupemail,signupname,signupcnic,signuppassword,type;
        ...
        body: Container(
          decoration: BoxDecoration(
            image: DecorationImage(
              ...
              fit: BoxFit.cover,
              colorFilter: new ColorFilter.mode(Colors.black26.withOpacity(0.8), BlendMode.dstATop),
            ),
          ),
          child: Center(
                              ...
                              if (user == null) {
                                ...
                                if(cnic==cnicfromdb)
                                {
                                  ...
                                  if(doc2){
                                    ...
                                    type = 'driver';
                                    //Navigator.push(context, MaterialPageRoute( builder: (context) => Main(type: type)));
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(padding: const EdgeInsets.symmetric(vertical: 5, horizontal: 100),
                      child: MaterialButton(
                        onPressed: () async {
